...
class DetectionService:
    ...
    def process_detected_plate(self, raw_text):
        ...
        # Regex για ελληνικό format (3 γράμματα που συνοδεύονται από 1- 4 αριθμούς , για να συμπεριλάβουμε και 
        # πινακίδες δικύκλων που έχουν 3 γράμματα αλλά από 1 έως 3 αριθμούς). Με αλλαγή στο regex μπορούμε να 
        # συμπεριλάβουμε και πινακίδες με 2 γράμματα (π.χ. για παλιά οχήματα) ή να επεκτείνουμε την αναζήτηση 
